...
lo=Label(win,text='START UP PROFIT PREDICTION SYSTEM',width=40,bg='white',
...
l5=Label(win,text='PROFIT PREDICTION IS HERE !!!',bg='white',fg='black',width=40,height=5,bd=5,
